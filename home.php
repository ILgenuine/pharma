...
<html lang="en">
  ...
  <!-- START NAVBAR -->
      ...
      <div class="wrapper">
        <!-- CONTENT -->
         <div class="container home-padding">
            <div class="row">
              <div class="col-xl-6 col-md-6 col-lg-6 col-12 slideInUp animated">
                  <div class="home-font-h"><u>PHARMA+</u></div>
                  <div class="home-font-1">
   ...
   <div class="w-100 home-bg fadeInUp animated">
       <div class="container home-bg2 home-padding">
  ...
  <div class="modal fadeIn animated" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-block" role="document">
            <div class="modal-content  modal-w-h">
                <div class="modal-body modal-padding">
                   <div class="row">
                      <div class="col-xl-2 col-lg-2 col-md-1 col-1"></div>
                      <div class="col-xl-6 col-lg-6 col-md-7 col-7 px-0">
                   ...
                   <div class="row pt-2">
                      ...
                      <div class="col-xl-11 col-lg-10 col-md-10 col-11">
                          <div class="home-modal-font3 home-modal-m-l">เมืองเอก เมืองปทุมธานี  12000</div>
                      </div>
                   </div>
                   <div class="row pt-2">
                      <div class="col-xl-1 col-lg-1 col-md-1"></div>
                      <div class="col-xl-2 col-lg-2 col-md-2 col-3">
                          <div class="home-modal-font2 home-modal-m-l3">โทร</div>
                      </div>
                      <div class="col-xl-9 col-lg-9 col-md-9 col-9">
                          <div class="home-modal-font2">: +66 (0) 2 123 4567-8</div>
                      </div>
                   </div>
                   <div class="row pt-2">
                      <div class="col-xl-2 col-lg-2 col-md-2 col-1"></div>
